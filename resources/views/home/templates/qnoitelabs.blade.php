<section class="qnoitelabs">
    <div class="container py-5">
        <div class="text-white mx-4 mx-md-0">
            ...
            <div class="d-flex gap-4">
                <a href="/" class="bg-white col-5 col-md-3 text-center rounded py-2"
                    style="text-decoration: none; color: #252525;"> Kunjungi Qnoitelabs. </a>
                <a href="/" class="bg-transparent col-5 col-md-3 text-center rounded py-2 text-white"
