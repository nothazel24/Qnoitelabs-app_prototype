        ...
        <div class="col-lg-6">
            <div class="card">
                <div class="card-header">
                    Edit Kategori: {{ $webCategory->name }}
                </div>
                <div class="card-body">
                    <form action="{{ route('admin.webCategories.update', $webCategory->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-lg-12 mb-3">
                                ...
                                <input type="text" class="form-control @error('name') is-invalid @enderror"
                                    id="name" name="name" value="{{ old('name', $webCategory->name) }}" required autofocus>
                                @error('name')
