        ...
        <div class="col-lg-4">
            ...
            @else
                <div class="ratio ratio-1x1 rounded d-flex align-items-center"
                    ...
                    <h1 class="text-white ms-lg-5 ms-3" style="margin-top: 18%"><b>Qnoite.com </b> <br> <small>Qnoite website
                            products</small></h1>
                </div>
            @endif
        </div>
        ...
        <div class="col-lg-8">
            ...
            <div class="card-body p-4 p-md-5">
                ...
                <div class="text-muted mb-4 d-flex flex-wrap align-items-center small"> {{-- Mengurangi ukuran font meta --}}
                    ...
                    <span class="me-3">
                        <i class="fas fa-tag me-1"></i> Kategori: <strong>{{ $product->website_category->name }}</strong>
                    </span>
                    <span class="me-3">
